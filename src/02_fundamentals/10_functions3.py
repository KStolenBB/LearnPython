...
# This is due to a language feature called mutability. It's not important to understand this now, 
# but just know that they behave differently to integers and strings behind the scenes when 
# you change them.
